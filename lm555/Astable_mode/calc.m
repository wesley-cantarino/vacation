...
R1 = 2.2*10^3     %%responsavel pela carga (tempo de high)
R2 = 30*10^3      %%responsavel pela carga (tempo de high) e descarga (tempo de low)
C = 22*10^-6      %%quant maior, menor a frequencia
